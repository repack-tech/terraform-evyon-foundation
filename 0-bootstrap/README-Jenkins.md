...
- Required information:
  - Terraform version 0.14.12 - See [Requirements](#requirements) section for more details.
...
1. Run terraform commands.
    ...
    - **Use Terraform 0.14.12** to run the terraform script with the commands below
    ```
    terraform init
    terraform plan
    terraform apply
